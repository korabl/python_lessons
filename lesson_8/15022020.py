...
input_data = input('Ð’Ð²ÐµÐ´Ð¸Ñ‚Ðµ Ð¿Ð¾Ð»Ð¾Ð¶Ð¸Ñ‚ÐµÐ»ÑŒÐ½Ð¾Ðµ Ñ‡Ð¸ÑÐ»Ð¾: ')

try:
    input_data = int(input_data)
    if input_data < 0:
        raise OwnError('Ð’Ñ‹ Ð²Ð²ÐµÐ»Ð¸ Ð¾Ñ‚Ñ€Ð¸Ñ†Ð°Ñ‚ÐµÐ»ÑŒÐ½Ð¾Ðµ Ñ‡Ð¸ÑÐ»Ð¾')
    else:
        print('Ð’ÑÐµ Ð¾Ðº')
except OwnError as err:
    print(err)
except ValueError:
    print('Ð’Ñ‹ Ð²Ð²ÐµÐ»Ð¸ Ð½Ðµ Ñ‡Ð¸ÑÐ»Ð¾')
